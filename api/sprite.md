...
Returns a new [tileset](tileset.md#tileset) and adds it to the sprite's tilesets.
...
If another tileset is passed as the only parameter, the result is a duplicate of it. Take into
consideration that the passed tileset cannot belong to another sprite.
